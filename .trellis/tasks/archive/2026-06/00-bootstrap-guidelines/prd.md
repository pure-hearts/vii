...
### Package: @vyron/cli (`spec/cli/`)

- Backend guidelines: `.trellis/spec/cli/backend/`

- Frontend guidelines: `.trellis/spec/cli/frontend/`

### Package: @vyron/release (`spec/release/`)

- Backend guidelines: `.trellis/spec/release/backend/`

- Frontend guidelines: `.trellis/spec/release/frontend/`

### Package: @vyron/utils (`spec/utils/`)
